...
function Navbar() {
    ...
    return (
        <nav className="z-[100] w-full mb-10 bg-navcolor border-gray-200 dark:bg-gray-900 fixed top-0 select-none">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-3">
                ...
                <div className="w-full md:block md:w-auto">
                    ...
                    >
                        {/* item nav link 1 */}
                        <li>
                            <a className="block py-2 px-3 text-white hover:text-black rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">
                                Home
                            </a>
                        </li>
                        {/* item nav link 2 */}
